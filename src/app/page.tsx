...
export default function Home() {
  ...
  const services = [
    ...
    {
      title: "Mobiles Applications",
      icon: <Smartphone className="w-8 h-8" />,
      description: " Dévelopement des applcation mobiles natives et  hybrid  pour IOS et Android"
    },
    {
      title: "Design UI/UX",
      icon: <Palette className="w-8 h-8" />,
      description: "Conception d'interfaces utilisateurs intuitives et esthétiques  pour une experience utilisateur optimale"
    },
    {
      title: "Optimization des Performances",
  ...
  return (
    <>
    <div className="min-h-screen p-8 bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 ">
